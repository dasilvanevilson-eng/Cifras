-- Espelha a musica atual quando o lider navega dentro de um repertorio publico.
...
drop function if exists public.update_public_banda_coral_state(text, text, uuid, uuid, integer, integer);
...
grant execute on function public.update_public_banda_coral_state(text, text, uuid, uuid, uuid, integer, integer) to anon, authenticated;
