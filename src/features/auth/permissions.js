...
export const PERMISSION_MODULES = [
  ...
  { key: 'acordes', label: 'Dicionario de acordes', description: 'Consulta de acordes e posicoes para violao.' },
  { key: 'afinador', label: 'Afinador', description: 'Afinador de violao por microfone.' },
